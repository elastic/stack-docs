...
* link:https://www.elastic.co/guide/en/elastic-stack/8.0/upgrading-elastic-stack.html[Upgrading the Elastic Stack]
* link:https://www.elastic.co/guide/en/elasticsearch/reference/8.0/setup-upgrade.html[Upgrading Elasticsearch]
...
For more information, refer to link:https://www.elastic.co/guide/en/elasticsearch/reference/{minor-version}/breaking-changes.html[Breaking changes in {minor-version}].

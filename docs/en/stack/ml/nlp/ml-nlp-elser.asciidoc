...
Overall the platform specific V2 model ingested at a max rate of 25.90 docs/s, 
compared with the ELSER V1 max rate of 13.65 docs/s from the ELSER V1 benchamrk, 
resulting in a 90% increase in throughput.

Furthermore, a significant performance improvement is found in ELSER V1 on 8.11, 
when compared to 8.9, with maximum throughputs of 16.13 and 13.65 docs/s 
respectively.
...
(ELSER V1 on 8.11) and 19.5% (for ELSER V2 platform specific).
...
the performance at 8 allocations was 21.67, while the performance of 16 
allocations was 25.90, indicating a 19.5% performance increase due to virtual 
...
respectively 14.05 and 15.78, indicating a performance improvement due to 
virtual cores of 12.3%.

...
= Predicting numerical values with {reganalysis}
...
deployed and used as functions. The <<ml-inference-regression>> section shows 
you how to use your model in a preprocessor of an ingest pipeline or in a 

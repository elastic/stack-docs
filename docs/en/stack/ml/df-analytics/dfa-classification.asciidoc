...
and multi-class {classification}. The more classes you have, the more complex 
the confusion matrix is. The matrix tells you how many data points that belong 
to a given class were classified correctly and incorrectly. In other words, how 
many data points that belong to the X class were classified correctly and 
mistakenly classified as Y or Z or any other class in the dataset other than X.

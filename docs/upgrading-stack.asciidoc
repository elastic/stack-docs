...
TIP: Want to know which of the following steps apply to your stack? Use the
https://register.elastic.co/guide/upgrade[interactive upgrade guide] to build
a personal path through the upgrade docs.

...
Rollup jobs contain the configuration information and metadata necessary to roll
up specific indices. See {ref}/xpack-rollup.html[Rolling up historical data].
//Source: X-Pack
endif::xpack-terms[]
ifdef::elasticsearch-terms[]

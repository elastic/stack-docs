...
{ref}/evaluate-dfanalytics.html/[{evaluatedf-api}] that allows you to evaluate 
the {dfanalytics} performance against a marked up data set. It helps to 
understand error distributions and to know the points where is the {dfanalytics} 
...
The receiver operating characteristic curve is a plot that represents the 

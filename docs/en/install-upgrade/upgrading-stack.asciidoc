...
. If you have `.ml-anomalies-*` anomaly detection result indices created in Elasticsearch 7.x, reindex, mark as read-only, or delete them before you upgrade to 9.0.0. For more information, refer to <<anomaly-detection-results-migration, Migrate anomaly detection results>>.
. If you have transform destination indices created in Elasticsearch 7.x, reset, reindex, or delete them before you upgrade to 9.0.0. For more information, refer to <<breaking_90_transform_destination_index, Migrate transform destination indices>>.

...
include::{apm-repo-dir}/apm-breaking-changes.asciidoc[tag=715-bc]
...
include::{es-repo-dir}/migration/migrate_7_15.asciidoc[tag=notable-breaking-changes]
...
the complete list, go to {kibana-ref}/release-notes-7.15.0.html#breaking-changes-7.15.0[{kib} breaking changes].

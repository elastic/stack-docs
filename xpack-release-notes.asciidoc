...
{security}, {monitoring}, {watcher}, {reporting}, {xpack} {ml}, and {graph}.
--
...
Machine learning::
* Introduces {ml} in the Elastic Stack. See <<xpack-ml>>.
...
* Usage of Netty 3 for transport (`transport.type=security3`) or HTTP
  (`http.type=security3`) is deprecated and will be removed in X-Pack
...
include::{xes-repo-dir}/security/release-notes.asciidoc[]
include::{xkb-repo-dir}/monitoring/release-notes.asciidoc[]

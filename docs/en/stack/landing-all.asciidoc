...
include::ml/df-analytics/ml-dfa-overview.asciidoc[leveloffset=+1,lines=1..39]
include::ml/df-analytics/dfa-outlierdetection.asciidoc[]
include::ml/df-analytics/dfa-classification.asciidoc[]
include::ml/df-analytics/dfa-regression.asciidoc[]
include::ml/df-analytics/ml-inference.asciidoc[]
include::ml/df-analytics/ml-lang-ident.asciidoc[]
include::ml/df-analytics/evaluatedf-api.asciidoc[]
ifeval::["{buildtool}" == "asciidoctor"]
:!imagesdir:
endif::[]
ifeval::["{buildtool}" == "gradle"]

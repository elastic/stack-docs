...
include::{beats-repo-dir}/release-notes/breaking/breaking-7.9.asciidoc[tag=notable-breaking-changes]
...
include::{kib-repo-dir}/migration/migrate_7_9.asciidoc[tag=notable-breaking-changes]

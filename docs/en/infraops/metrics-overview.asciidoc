...
Then you can drill down to view more detailed metrics or other information for that component, or you can seamlessly switch to view corresonding logs, uptime information or APM traces where available.
// Add links to logs, uptime and APM when I have them.

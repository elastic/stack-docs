...
category of a given data point in a dataset. {infer-cap} enables you to use 
...
* Learn how to evaluate <<dfa-regression-evaluation,regression>> and 
<<dfa-classification-evaluation,classification>> models.

  ...
  "classification" : {
    "multiclass_confusion_matrix" : {
      "confusion_matrix" : [
        {
          "actual_class" : "false", 
          "actual_class_doc_count" : 912,
          "predicted_classes" : [
            {
              "predicted_class" : "false",  <1>
              "count" : 755 
            },
            {
              "predicted_class" : "true", <2>
              "count" : 157
            }
          ],
...
correctly (where the `actual_class` matches the `predicted_class` - see <1> and 
<4>) and how many were misclassified (`actual_class` does not match 
`predicted_class` - see [2] and [3]).

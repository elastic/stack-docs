...
locations with many anomalies are red.
//TBD: Is it possible to view a legend as is the case in the Data Visualizer?
Thus you can quickly see the locations that are generating the most anomalies.
If your vector layers define regions, counties, or postal codes, you can zoom
in for fine details.

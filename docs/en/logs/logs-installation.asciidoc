...
* Appropriate {beats} shippers (version 6.5 or later) installed and enabled on each of the systems you want to
monitor
...
To modify configuration settings, use the {kibana-ref}/xpack-logs-configuring.html[*Settings* tab in the {logs-app}].

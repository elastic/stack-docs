...
:description:                 Playing with Asciidoctor to create Elastic Observability docs
:keywords:                    Logs, Metrics, Traces, Uptime, APM
...
include::landing-observability.asciidoc[]
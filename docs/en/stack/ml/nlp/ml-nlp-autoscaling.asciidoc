...
NOTE: For Observability and Security projects on Serverless, adaptive allocations are automatically enabled, and the feature contols are not dosplayed in {kib}.

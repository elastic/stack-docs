...
For general plugin API changes, Plugin API migrations to the new {kib} Platform,
and other breaking changes, refer to the
{kibana-ref}/breaking-changes-7.6.html[{kib} documentation]. 

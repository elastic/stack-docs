...
Refer to {kibana-ref}/maps-connect-to-ems.html[Connect to {ems}] in the {kib} documentation to learn about how to configure your firewall to connect to {ems}, host it locally, or disable it completely.

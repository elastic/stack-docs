...
include::{es-repo-dir}/migration/migrate_8_9.asciidoc[tag=notable-breaking-changes]
...
<<<<<<< HEAD
the complete list, go to {security-guide-all}/8.8/release-notes-header-8.8.0.html#breaking-changes-8.8.1[{elastic-sec} breaking changes].
...
For the complete list, go to {kibana-ref}/release-notes-8.9.0.html#breaking-changes-8.9.0[{kib} breaking changes].

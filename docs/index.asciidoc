...
:major-version: 5.x
:branch:        5.x
:beatsref:      https://www.elastic.co/guide/en/beats/libbeat/5.x
:cloudref:      https://www.elastic.co/guide/en/cloud/current
:esref:         https://www.elastic.co/guide/en/elasticsearch/reference/5.x
:hadoopref:     https://www.elastic.co/guide/en/elasticsearch/hadoop/5.x
:kibanaref:     https://www.elastic.co/guide/en/kibana/5.x
:logstashref:   https://www.elastic.co/guide/en/logstash/5.x
:xpackref:      https://www.elastic.co/guide/en/x-pack/5.x

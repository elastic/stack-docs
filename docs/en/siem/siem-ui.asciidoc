...
to Timeline are indicated with two dotted vertical lines, and are highlighted
when you hover over a grid's row:
...
* Add to Timeline investigate: adds the field to Timeline

...
[[install]]
=== Install Elasticsearch, Kibana, Beats, Logstash
...
[[configure]]
=== Configure Elasticsearch, Kibana, Beats, Logstash 

[[run]]
=== Run Elasticsearch, Kibana, Beats, Logstash

[[start-stop]]
==== Start and stop Elasticsearch, Kibana, Beats, Logstash

...
For the complete list, go to {apm-server-ref}/breaking-changes.html[APM Server 7.0 breaking changes].

include::{apm-repo-dir}/apm-breaking-changes.asciidoc[tag=notable-v74-breaking-changes]
...
include::{kib-repo-dir}/migration/migrate_7_4.asciidoc[tag=notable-breaking-changes]

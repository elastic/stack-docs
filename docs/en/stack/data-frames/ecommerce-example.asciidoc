...
_Pivoting_ your data involves using at least one field to group your data and
applying at least one aggregation. You can preview what the transformed data
will look like, so go ahead and play with it!

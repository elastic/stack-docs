...
include::{apm-repo-dir}/apm-release-notes.asciidoc[tag=notable-v74-highlights]
...
include::{es-repo-dir}/reference/release-notes/highlights-7.4.0.asciidoc[tag=notable-highlights]
...
include::{kib-repo-dir}/release-notes/highlights-7.4.0.asciidoc[tag=notable-highlights]

...
include::{beats-repo-dir}/highlights-7.2.0.asciidoc[tag=notable-highlights]
...
include::{es-repo-dir}/reference/release-notes/highlights-7.2.0.asciidoc[tag=notable-highlights]

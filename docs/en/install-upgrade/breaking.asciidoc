...
include::{apm-repo-dir}/all-breaking-changes.asciidoc[tag=87-bc]
...
include::{es-repo-dir}/migration/migrate_8_7.asciidoc[tag=notable-breaking-changes]
...
the complete list, go to {kibana-ref}/release-notes-8.7.0.html#breaking-changes-8.7.0[{kib} breaking changes].

...
{kib} also provides a scatterplot matrix, which enables you to visualize the
relationships between pairs of fields. Outliers are highlighted in each
scatterplot and are affected by your choice of outlier score threshold.

...
specific ELSER model - that is, a model that can run only on Linux with an 
...
(ELSER V1 on 8.11) and 20% (for ELSER V2 platform specific). Tests were 
performed on a 16vCPU machine.

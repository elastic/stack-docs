...
for cancer in a DNA sequence. {classification-cap} is for predicting discrete, 
categorical values.
...
exclude fields from the analysis. For more information
about field selection, refer to the

...
[role="screenshot"]
image::images/ml-gs-web-config1.jpg["Job configuration details for sample web logs"]
...
--
[role="screenshot"]
image::images/ml-gs-job1.jpg["A graph of the mean total prices over time"]
--

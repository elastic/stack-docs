...
The RESTful API supports the standard HTTP methods: `GET`, `POST`, `PUT`, and `DELETE`. It is accessed via:

`<kibana URL>/api/detection_engine/rules`
...
space identifier is part of the call's URL:

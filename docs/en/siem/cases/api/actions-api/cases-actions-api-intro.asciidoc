...
. [[sn-returned-data]]<<cases-actions-api-execute>>: Send the case to {sn}
(Actions API). You must store the returned data as it is required for updating
the `external_service` object in the {siem-soln} case.

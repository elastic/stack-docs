...
** {apm-server-ref}/upgrading.html#breaking-changes[APM Server {version} breaking changes]
...
. If {xpack} **IS NOT** normally a part of your {stack}, disable {security}
...
. If you disabled {security} in `elasticsearch.yml`, also disable

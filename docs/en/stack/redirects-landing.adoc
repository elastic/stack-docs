...
[role="exclude",id="anomaly-algorithms"]
=== Anomaly detection algorithms

See {ml-docs}/ml-overview.html#anomaly-algorithms[Anomaly detection algorithms].

[role="exclude",id="dfa-outlier-detection"]
=== Outlier detection

See {ml-docs}/dfa-outlier-detection.html[Outlier detection].
...
[role="exclude",id="ml-inference"]
=== Inference

See {ml-docs}/ml-inference.html[Inference].

[role="exclude",id="ec-api-principles"]
=== Principles

TBD

[role="exclude",id="ec-api-authentication"]
=== Authentication

TBD

[role="exclude",id="ec-openapi-specification"]
=== OpenAPI specification

[role="exclude",id="ec-api-rate-limiting"]
=== Rate limiting

TBD

[role="exclude",id="ec-api-examples"]
=== API examples

...
https://docs.elastic.co/integrations[Elastic Integrations] are a streamlined way to add Elastic assets to your environment, such as data ingestion, transforms, and in this case, machine learning capabilities for Security.

The following Integrations are for the Security UEBA (user and entity behavioral analytics), which can help detect and alert when there is related suspicious activity in your environment.
...
// tag::security-integrations-jobs[]

*Domain Generation Algorithm (DGA) Detection (Integration)*
...
To download, see the https://docs.elastic.co/integrations/dga[documentation].
...
|https://github.com/elastic/integrations/blob/{branch}/packages/dga/kibana/ml_module/dga-ml.json[image:images/link.svg[A link icon]]
|https://github.com/elastic/integrations/blob/{branch}/packages/dga/kibana/ml_module/dga-ml.json[image:images/link.svg[A link icon]]

|===

*Living off the Land Attack (LotL) Detection (Integration)*

ML solution package to detect Living off the Land (LotL) attacks in your environment. Requires a Platinum subscription. (Also known as ProblemChild).

To download, see the https://docs.elastic.co/integrations/problemchild[documentation].
...
*Data Exfiltration Detection (DED) (Integration)*

ML package to detect data exfiltration in your network and file data.

To download, see the https://docs.elastic.co/integrations/ded[documentation].
...
To download, see the https://docs.elastic.co/integrations/lmd[documentation].

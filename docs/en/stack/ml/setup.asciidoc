...
list as a quick reference to check if your {es} cluster meets the conditions. 
Refer to the <<ml-nodes>> and <<setup-privileges>> sections for more details 
...
[role="screenshot"]
image::license-management.jpg["License management in {kib}"]

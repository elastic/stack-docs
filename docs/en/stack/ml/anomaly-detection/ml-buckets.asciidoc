...
Both the **Anomaly Explorer** and the **Single Metric Viewer** contains an 
...
helps you to interpret a given anomaly by providing further insights about it 
such as its type, impact, and score.

...
include::create-rule-api.asciidoc[tags=rules-api-json-schema;!exlude-rule-id-field]

===== Example request

This example updated the `name`, `description` and `query` fields:
...
*Frank: need help - I needed to add the type field to update the query - any other constraints?*

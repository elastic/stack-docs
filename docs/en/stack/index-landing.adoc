...
//Upgrade the stack
include::{stack-repo-dir}/../install-upgrade/upgrading-stack.asciidoc[leveloffset=+1]
...
include::{kib-repo-dir}/user/api.asciidoc[lines=34..42,leveloffset=+2]
...
include::ml/anomaly-detection/ootb-ml-jobs.asciidoc[lines=5..-1,leveloffset=+1]

...
include::{apm-repo-dir}/apm-breaking-changes.asciidoc[tag=notable-v77-breaking-changes]
...
include::{es-repo-dir}/reference/migration/migrate_7_7.asciidoc[tag=notable-breaking-changes]
...
in previous versions, go to {kibana-ref}/breaking-changes-7.7.html[{kib} breaking changes].

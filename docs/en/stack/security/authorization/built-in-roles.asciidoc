...
existing snapshot repositories and snapshot details. It does not permit to
remove or add repositories or to restore snapshots. It also does not permit
index settings changes or to read or update index data.

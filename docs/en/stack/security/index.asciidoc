...
////
TEMPORARILY OMIT:For even greater protection, you can increase the <<ciphers, encryption strength>> and
...
//TEMPORARILY OMIT:include::{xes-repo-dir}/security/reference.asciidoc[]

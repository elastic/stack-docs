...
For versions prior to 8.18.2, it is strongly advised to first upgrade to 8.18.2 prior to upgrading to 9.0.x. Otherwise, logsdb will be enabled by default regardless of whether matching data streams exist.

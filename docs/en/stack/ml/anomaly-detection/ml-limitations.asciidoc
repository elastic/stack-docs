...
enabled),
* if the datafeed uses scripted fields and model plot is not enabled (except
...
.Detector function support in the Single Metric Viewer
[options="header"]
|===================================================================================================================================================================================================
...
| distinc_count, high_distinct_count, low_distinct_count                                                                                       | <<ml-count-functions, Count functions>> | yes         
...
| varp, high_varp, low_varp                                                                                                                    | <<ml-metric-varp>>                      | no         
| lat_long                                                                                                                                     | <<ml-lat-long>>                         | no         
| info_content, high_info_content, low_info_content                                                                                            | <<ml-info-content>>                     | no         
| rare                                                                                                                                         | <<ml-rare>>                             | yes         

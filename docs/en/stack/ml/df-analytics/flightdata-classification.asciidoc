...
= Predicting classes of data points with {classanalysis}
...
deployed and used as functions. The <<ml-inference-classification>> section 
shows you how to use your model in a preprocessor of an ingest pipeline or in a 
pipeline aggregation of a search query to make predictions about your data.
...
about new data. Those steps are not covered in this example.

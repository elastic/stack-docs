...
This page contains a conceptual overview of 
{oldetection} in the {stack} and a simple
<<ecommerce-outliers,example>> of how to use it.
...
The {ml-features} provide unsupervised {oldetection}, which means there is no need to provide a 

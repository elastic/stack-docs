...
include::{beats-repo-dir}/release-notes/breaking/breaking-7.8.asciidoc[tag=notable-breaking-changes]
...
in previous versions, go to {hadoop-ref}/breaking-changes.html[Elasticsearch
Hadoop breaking changes].

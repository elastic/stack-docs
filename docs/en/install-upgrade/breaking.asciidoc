...
include::{beats-repo-dir}/release-notes/breaking/breaking-7.11.asciidoc[tag=notable-breaking-changes]
...
include::{es-repo-dir}/migration/migrate_7_11.asciidoc[tag=notable-breaking-changes]
...
include::{kib-repo-dir}/migration/migrate_7_11.asciidoc[tag=notable-breaking-changes]

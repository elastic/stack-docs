...
IMPORTANT: {kib} has a new logging system in 8.0 and the {kibana-ref}/_upgrading_multiple_kibana_instances.html#logging-config-changes[log formats have changed]. 

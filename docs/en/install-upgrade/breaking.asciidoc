...
include::{beats-repo-dir}/release-notes/breaking/breaking-8.2.asciidoc[tag=notable-breaking-changes]
...
This list summarizes the most important breaking changes in {elastic-sec} {version}. For the complete list, go to {security-guide-all}/8.2/release-notes-header-8.2.0.html#breaking-changes-8.2.0[{elastic-sec} breaking changes].
...
//{kibana-ref}/release-notes-8.0.0.html#breaking-changes-8.0.0[{kib} breaking changes].

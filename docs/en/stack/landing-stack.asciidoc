...
ifeval::["{buildtool}" == "gradle-nooffsets"]
:imagesdir: elasticsearch/docs/reference/transform
include::{es-repo-dir}/transform/index.asciidoc[lines=4..12]
endif::[]
ifeval::["{buildtool}" == "builddocs"]
include::{es-repo-dir}/transform/index.asciidoc[lines=4..32,leveloffset=+1]
endif::[]
...
[[realms]]
==== Realms
include::{xes-repo-dir}/security/authentication/realms.asciidoc[lines=4..53]

[[roles]]
==== Role-based access control
include::{xes-repo-dir}/security/authorization/overview.asciidoc[lines=14..62]
:!imagesdir:
endif::[]

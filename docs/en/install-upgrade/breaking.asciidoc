...
//{security-guide}/release-notes-header-8.1.0.html#breaking-changes-8.1.0[{elastic-sec} breaking changes].
...
>>>>>>> d2ee442 ([DOCS] Add Elastic Security breaking changes to Installation and Upgrade Guide for 8.2 (#2099))

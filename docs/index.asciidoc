...
:major-version: 5.x
:branch:        5.5
:beatsref:      https://www.elastic.co/guide/en/beats/libbeat/5.5
:cloudref:      https://www.elastic.co/guide/en/cloud/current
:esref:         https://www.elastic.co/guide/en/elasticsearch/reference/5.5
:hadoopref:     https://www.elastic.co/guide/en/elasticsearch/hadoop/5.5
:kibanaref:     https://www.elastic.co/guide/en/kibana/5.5
:logstashref:   https://www.elastic.co/guide/en/logstash/5.5

...
Detects network events that may indicate the use of Windows file sharing (also
...
*Version*: 3 (<<smb-windows-file-sharing-activity-to-the-internet-history, version history>>)
